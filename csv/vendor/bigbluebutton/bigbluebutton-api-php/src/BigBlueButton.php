...
class BigBlueButton
{
    ...
    protected $jSessionId;
     ...
     public function __construct($url,$sec)
    {
        // Keeping backward compatibility with older deployed versions
        $this->securitySecret   = $sec; //(getenv('BBB_SECURITY_SALT') === false) ? getenv('BBB_SECRET') : $this->securitySecret = getenv('BBB_SECURITY_SALT');
        $this->bbbServerBaseUrl = $url;//getenv('BBB_SERVER_BASE_URL');
